...
class EAGLEDraftCudaGraphRunner(DecodeCudaGraphRunner):
    ...
    def _attach_hisparse_coordinator(
        ...
        """Publish the raw request count before a padded draft graph replay."""
    ...
    def can_run_graph(self, forward_batch: ForwardBatch):
        ...
        if self.require_mlp_sync and not forward_batch.can_run_dp_draft_cuda_graph:
            return decide(False, "draft_dp_vote", graph_batch_size=cuda_graph_bs)
