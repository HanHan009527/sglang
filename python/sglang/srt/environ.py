...
class Envs:
    ...
    # 0 derives the launch size from DeepGEMM's current SM budget. MegaMoE
    # kernels use a whole-grid software barrier, so leave a small residency
    # margin for work launched concurrently on another CUDA stream.
